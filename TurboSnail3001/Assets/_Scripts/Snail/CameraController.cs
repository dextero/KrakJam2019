...
public class CameraController : MonoBehaviour
{
    ...
    [SerializeField, FoldoutGroup("Settings")] private float _TranslationSpeed = 1.0f;
    [SerializeField, FoldoutGroup("Settings")] private float _RotationSpeed = 1.0f;
    ...
    private void FixedUpdate()
    {
        ...
        _Transform.position = Vector3.Lerp(_Transform.position, _Target.position + offset, Time.deltaTime * _TranslationSpeed);
